...
Use these local guides for method-section structure. Extended paper passages have been replaced by teaching summaries in the public copy.
...
3. Module design analysis (Instant-NGP): `references/examples/method/module-design-instant-ngp.md`
...
3. Three-element structural summary: `references/examples/method/example-of-the-three-elements.md`
